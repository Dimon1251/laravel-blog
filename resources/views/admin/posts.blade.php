                ...
                <div class="row">
                    @foreach($posts as $post)
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="card">
                                <img class="card-img-top" src="{{Storage::get('post'.$post->id.'.jpg')}}" alt="Unsplash">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="dashboard/posts/edit/{{$post->id}}" class="card-link">Edit</a>
                                    <a href="admin/post/{{$post->id}}/delete" class="card-link">Delete</a>
                                </div>
                            </div>
                    </div>
                    @endforeach
