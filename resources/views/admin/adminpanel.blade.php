...
<head>
   ...
   <link href="{{ asset('admin/css/modern.css?v='.config('app.version')) }}" rel="stylesheet">
    ...
    <script src="{{ asset('admin/js/settings.js?v='.config('app.version')) }}"></script>
    <!-- END SETTINGS -->
</head>
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item active">
                    ...
                    <ul id="dashboards" class="sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
                        <li class="sidebar-item active"><a class="sidebar-link" href="{{ route('dashboard-posts') }}">Posts</a></li>
                        <li class="sidebar-item"><a class="sidebar-link" href="{{ route('dashboard-comments') }}">Comments</a></li>
                        <li class="sidebar-item"><a class="sidebar-link" href="{{ route('dashboard-users') }}">Users</a></li>
                    </ul>
                </li>
                            ...
                            <div class="list-group">
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="./admin/img/avatars/avatar-5.jpg" class="avatar img-fluid rounded-circle" alt="Michelle Bilodeau">
                                        </div>
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="./admin/img/avatars/avatar-3.jpg" class="avatar img-fluid rounded-circle" alt="Kathie Burton">
                                        </div>
                                        <div class="col-10 ps-2">
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="./admin/img/avatars/avatar-2.jpg" class="avatar img-fluid rounded-circle" alt="Alexander Groves">
                                        </div>
                                        <div class="col-10 ps-2">
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="./admin/img/avatars/avatar-4.jpg" class="avatar img-fluid rounded-circle" alt="Daisy Seger">
                                        </div>
                                        <div class="col-10 ps-2">
