            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item active">
                    ...
                    <ul id="datatables" class="sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
                        <li class="sidebar-item active"><a class="sidebar-link" href="tables-datatables-responsive.html">Responsive Table</a></li>
                ...
                <div class="header">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Responsive DataTables</li>
                        </ol>
                    </nav>
                </div>
                <div class="row">
                                    ...
                                    @foreach($comments as $comment)
                                        <tr>
                                            ...
                                            <td class="table-action">
                                                <a href="admin/comment/{{$comment->comment_id}}/delete"><i class="align-middle fas fa-fw fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
