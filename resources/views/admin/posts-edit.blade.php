            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item active">
                    ...
                    <ul id="ui" class="sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
                        ...
                        <li class="sidebar-item active"><a class="sidebar-link" href="ui-notifications.html">Notifications</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-header">
                                <h5 class="card-title">Toastr notifications</h5>
                                <h6 class="card-subtitle text-muted">Simple JavaScript toast notifications.</h6>
                            </div>
                            <div class="card-body">
                                <form action="update" method="post">
                                    @csrf
                                    <input hidden id="id" name="id" type="text" class="form-control" value="{{$post->id}}">
                                    <div class="row">
